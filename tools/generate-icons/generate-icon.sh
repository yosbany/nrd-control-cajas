#!/bin/bash
# Generador de iconos para NRD Control de Cajas
# Uso: ./generate-icon.sh "TEXTO_DEL_ICONO"
# Ejemplo: ./generate-icon.sh "NRD CONTROL DE CAJAS"
...
if [ -z "$1" ]; then
    ...
    echo "   Ejemplo: ./generate-icon.sh \"NRD CONTROL DE CAJAS\""
    exit 1
fi
...
python3 "$SCRIPT_DIR/generate-icons.py" "$ICON_TEXT"
