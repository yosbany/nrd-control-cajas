...
# Obtener el directorio raíz del proyecto (dos niveles arriba de tools/nrd-control-cajas-server)
...
start_server() {
    ...
    echo "   Accede a: http://localhost:$PORT"
    echo "   Para detener: ./tools/nrd-control-cajas-server/server.sh"
